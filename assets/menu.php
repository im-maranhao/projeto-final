<nav class="navbar navbar-expand-lg navbar-light bg-dark">
    ...
    <!-- <a class="navbar-brand" href="inicio.php">
        <img src="logo.jpg" alt="LOGO" width="55" class="rounded-circle" />
        <span class="d-inline-block text-warning p-2" style="max-width: 200px;">Bem Vindo à Casa</span>
    </a> -->
            ...
            <li class="nav-item dropdown mr-2">
                <a class="nav-link dropdown-toggle text-white" href="#" id="navbarDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                 ...
                 <div class="dropdown-menu" aria-labelledby="navbarDropdown"> 
                    <a class="dropdown-item" href="gerenciamento.php">Alunos</a>
                    <div class="dropdown-divider"></div>
                    
                    <a class="dropdown-item" href="#" data-toggle="modal" data-backdrop="static" data-keyboard="false" data-target="#cadCliente">Novo Aluno</a>
                    <div class="dropdown-divider"></div>
